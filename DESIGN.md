...
Forgot is a grade, not a state, and its mark is the red turn-back arrow wherever it shows: the Forgot grade, the Forgot today tile, Review forgotten at the end of a review, and the chip on a relearning card. Relearning counts as Learning in the filter and on Insights, and on its own card the chip says **Forgot recently** rather than the schedule's name for it.

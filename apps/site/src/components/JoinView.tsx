    ...
    <AuthFrame>
      <section className="edge min-w-0 rounded-xl bg-plate p-6 @xl:p-10">
        <div className="text-center">
          <h1 className="text-2xl font-medium tracking-[-0.02em] text-text">Request access</h1>
          <p className="mx-auto mt-2 max-w-[38ch] text-md text-text-2">
            Lymi is private for now. Leave your email, and we’ll write if a place opens.
          </p>
        </div>

      ...
      <Steps>
        ...
        <div>
          ...
          <p>
            ...
            <strong>Import</strong> choose <strong>Anki</strong>. Choose the file, or drop it on the
            page. Keep Lymi open while the file uploads; a large file on a slow connection can take
            a few minutes.
          </p>
        </div>
        <div>

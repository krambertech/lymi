...
test(
  desktop
    ...
    : "the pill opens the streak over the whole screen, named by the run, and its close button closes it",
  async () => {
    await render(

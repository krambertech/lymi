...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex shrink-0 flex-col gap-1 p-4 pb-0 text-start", className)}
      {...props}
    />
  );
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6858769ef477deeb12b47dc9c76f9f25)
...
interface __BaseEnv_Env {
	...
	OPERATOR_EMAILS: "kateryna@buffer.com,k.porshnieva@gmail.com";
	PUBLISHER_EMAILS: "library@lymi.app";
	LIVE: DurableObjectNamespace<import("./src/server/index").LiveChannel>;
	IMPORT_WORKFLOW: Workflow<Parameters<import("./src/server/index").ImportWorkflow['run']>[0]['payload']>;
	EXPORT_WORKFLOW: Workflow<Parameters<import("./src/server/index").ExportWorkflow['run']>[0]['payload']>;
	ENRICH_WORKFLOW: Workflow<Parameters<import("./src/server/index").EnrichWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "LiveChannel";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SITE_URL" | "PRODUCT_URL" | "OPERATOR_EMAILS" | "PUBLISHER_EMAILS">> {}
}

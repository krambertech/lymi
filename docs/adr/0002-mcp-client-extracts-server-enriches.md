...
Enrichment runs automatically in the background after any add that leaves fields empty, from the web quick-capture sheet as much as from an integration.

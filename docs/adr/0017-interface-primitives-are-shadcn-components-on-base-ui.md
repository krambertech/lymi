...
| Place | Centred dialog, docked beside the page, or a side sheet at the end edge, ending in a close button | A page over the whole screen that arrives from the end edge and leaves by a named back button (changed 19 September 2026: a close button beside back buttons, and two directions of arrival, left it unclear how to leave) |

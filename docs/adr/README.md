...
| [0010](0010-the-review-queue-is-ordered-by-retrievability.md) | Superseded by 0019: the review queue is ordered by retrievability, not by due date |
...
| [0019](0019-the-review-queue-is-a-deterministic-weighted-draw.md) | The review queue is a deterministic weighted draw with no saved state |

...
On a published deck's page, a picture sits with its card rather than in the page's decorative spread. The card list keeps the term readable beside the picture, and the try-it card shows the picture without hiding its term. Pronunciation has a named play control and never starts on its own.

...
**Status:** Accepted for implementation on 13 September 2026. Product behavior is fixed in [the accepted proposal](../proposals/daily-review-goal-and-rolling-queue.md), [PRODUCT.md](../../PRODUCT.md), and [DESIGN.md](../../DESIGN.md). This plan chooses persistence, synchronization, and delivery order; it does not authorize deployment.

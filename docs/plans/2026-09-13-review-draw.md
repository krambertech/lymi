...
3. **Goal screen** ([#152](https://github.com/krambertech/lymi/issues/152)). Show Daily goal reached, Nothing left today, or Nothing due from the server. Add Review forgotten, Review another round of 10, and Done. Done when each works on phone and desktop, by keyboard and with reduced motion.

...
| [Daily review goal and rolling queue](daily-review-goal-and-rolling-queue.md) | Accepted; queue revised by ADR 0019 and planned in [docs/plans/2026-09-13-review-draw.md](../plans/2026-09-13-review-draw.md) |
...
| [Native mobile app](native-mobile-app.md) | Exploration |
...
| [Import from Anki and Mochi, and export](importing-from-other-apps.md) | Accepted; tracked in [#227](https://github.com/krambertech/lymi/issues/227), [#228](https://github.com/krambertech/lymi/issues/228) and [#229](https://github.com/krambertech/lymi/issues/229) |

...
1. **The domain is not registered with either search engine.** Confirmed by the owner on 13 September 2026: `lymi.app` has not been added to Google Search Console or Bing Webmaster Tools, so no sitemap has been submitted and nothing has asked either index to look. Everything else in this proposal is moot until ownership is verified and the sitemap is processed.

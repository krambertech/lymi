...
INSERT INTO card_images (id, card_id, user_id, object_key, content_type, width, height, byte_size, description, source_kind, created_by) VALUES
  ('e2e-image-1', 'e2e-card-3', 'e2e-publisher', 'PRIVATE-e2e-image-1', 'image/webp', 320, 240, 64, 'A lamp lit in a dark window', 'upload', 'user');
